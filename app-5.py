...
/* v1.9 · 主题换色 + 更完整的首页布局 */
:root{--glow-a:rgba(191,205,170,.30);--glow-b:rgba(236,225,198,.62);--paper-rgb:255,254,249;--accent:#78996f;--accent-2:#66865f;--accent-soft:#edf4e9;--line:#d6e2cf}
html[data-theme="matcha"]{--bg:#f8f4e9;--paper:#fffef9;--ink:#1f3b2f;--text:#415249;--muted:#7b847d;--sage:#78996f;--sage-2:#66865f;--sage-soft:#edf4e9;--sage-line:#d6e2cf;--accent:#78996f;--accent-2:#66865f;--accent-soft:#edf4e9;--line:#d6e2cf;--glow-a:rgba(191,205,170,.30);--glow-b:rgba(236,225,198,.62)}
html[data-theme="cream"]{--bg:#fbf1e6;--paper:#fffaf4;--ink:#573d31;--text:#654f44;--muted:#958377;--sage:#c58f70;--sage-2:#ad7458;--sage-soft:#fae8dc;--sage-line:#ead4c4;--accent:#c58f70;--accent-2:#ad7458;--accent-soft:#fae8dc;--line:#ead4c4;--glow-a:rgba(234,190,158,.32);--glow-b:rgba(246,220,188,.62)}
html[data-theme="mist"]{--bg:#edf4f6;--paper:#fbfdfe;--ink:#294653;--text:#49606a;--muted:#7f9198;--sage:#7397a4;--sage-2:#5f8390;--sage-soft:#e4eff2;--sage-line:#cfdee3;--accent:#7397a4;--accent-2:#5f8390;--accent-soft:#e4eff2;--line:#cfdee3;--glow-a:rgba(165,199,209,.34);--glow-b:rgba(215,230,235,.68)}
html[data-theme="rose"]{--bg:#faf0f1;--paper:#fffafb;--ink:#5a3a42;--text:#6c5057;--muted:#988087;--sage:#b98691;--sage-2:#a46f7b;--sage-soft:#f6e5e8;--sage-line:#e7cfd5;--accent:#b98691;--accent-2:#a46f7b;--accent-soft:#f6e5e8;--line:#e7cfd5;--glow-a:rgba(221,174,185,.32);--glow-b:rgba(240,214,219,.65)}
html[data-theme="lilac"]{--bg:#f3f0f8;--paper:#fdfbff;--ink:#463d5a;--text:#5b536c;--muted:#8b8498;--sage:#8e84aa;--sage-2:#766c94;--sage-soft:#ece8f4;--sage-line:#dcd5e9;--accent:#8e84aa;--accent-2:#766c94;--accent-soft:#ece8f4;--line:#dcd5e9;--glow-a:rgba(190,181,215,.34);--glow-b:rgba(225,220,238,.68)}
body{background:radial-gradient(circle at 88% 8%,var(--glow-a),transparent 20rem),radial-gradient(circle at 4% 85%,var(--glow-b),transparent 25rem),linear-gradient(180deg,var(--paper) 0%,var(--bg) 100%)}
.shell{padding-top:calc(18px + env(safe-area-inset-top))}.hero{grid-template-columns:96px minmax(0,1fr);gap:20px;padding:24px 8px 22px}.logo{width:94px;height:94px;border-radius:27px}.hero h1{font-size:clamp(48px,11vw,64px);margin-bottom:8px}.hero p{font-size:17px;padding-right:36px}.decor{top:28px}
.card{background:rgba(var(--paper-rgb),.96);border-color:color-mix(in srgb,var(--line) 82%,#fff);box-shadow:0 16px 42px rgba(51,73,53,.09)}
.status{background:linear-gradient(145deg,color-mix(in srgb,var(--accent-soft) 72%,#fff),color-mix(in srgb,var(--accent-soft) 92%,#fff));border-color:var(--line)}
.status-top{grid-template-columns:1fr 1fr auto}.status-icon{background:var(--accent)}.status-sub{display:block;margin-top:3px;color:var(--muted);font-size:12px}.status-main{min-width:0}.status-check{justify-self:end}.model-row{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-top:17px;padding-top:16px;border-top:1px solid var(--line);color:var(--text)}.model-name{font-weight:760;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pill{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;background:var(--accent-soft);color:var(--accent-2);font-size:11px;font-weight:750}.api-source{margin-left:auto;color:var(--muted);font-size:12px}.tool-row{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:16px}.tool-btn{border:1px solid var(--line);background:rgba(255,255,255,.62);color:var(--accent-2);border-radius:16px;padding:12px 8px;font-weight:780;cursor:pointer;min-width:0}.tool-btn span{display:block;font-size:12px;font-weight:550;color:var(--muted);margin-top:3px}
.upload{padding:26px}.file-row{display:block}.file-label{width:100%;min-height:132px;display:flex;justify-content:center;align-items:center;flex-direction:column;gap:8px;border:1.8px dashed color-mix(in srgb,var(--accent) 78%,#fff);border-radius:22px;background:linear-gradient(145deg,rgba(255,255,255,.72),color-mix(in srgb,var(--accent-soft) 32%,#fff));font-size:17px}.file-label .upload-icon{font-size:34px;line-height:1}.file-label small{font-size:12px;color:var(--muted);font-weight:550}.filename{display:block;width:100%;padding:10px 4px 0;text-align:center}.persona-line{position:relative;margin-top:14px;padding:15px 46px 15px 54px;border-radius:19px;background:linear-gradient(100deg,color-mix(in srgb,var(--accent-soft) 44%,#fff),color-mix(in srgb,#f5eedc 72%,#fff));font-size:15px}.persona-line:before{content:'◉';position:absolute;left:17px;top:50%;transform:translateY(-50%);width:27px;height:27px;border-radius:10px;display:grid;place-items:center;background:var(--accent-soft);color:var(--accent-2);font-size:13px}.persona-line:after{content:'♡';position:absolute;right:17px;top:50%;transform:translateY(-50%);color:color-mix(in srgb,var(--accent) 60%,#c6b18d)}.primary{background:linear-gradient(135deg,var(--accent),var(--accent-2));box-shadow:0 12px 28px color-mix(in srgb,var(--accent) 25%,transparent)}.progress-bar{background:linear-gradient(90deg,color-mix(in srgb,var(--accent) 78%,#fff),var(--accent-2))}.badge-icon,.info{background:var(--accent-soft);color:var(--accent-2)}.info{background:var(--accent);color:#fff}.recent-item{background:color-mix(in srgb,var(--accent-soft) 30%,#fff);border-color:var(--line)}.footnote{border-color:var(--line);background:color-mix(in srgb,var(--accent-soft) 52%,#fff)}
.theme-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin-top:16px}.theme-choice{border:1px solid #e5e0d5;background:#fff;border-radius:18px;padding:10px 6px;text-align:center;color:#5f665f;cursor:pointer}.theme-choice.active{outline:2px solid var(--accent);outline-offset:2px}.swatch{width:34px;height:34px;border-radius:50%;margin:0 auto 7px;border:3px solid rgba(255,255,255,.85);box-shadow:0 0 0 1px rgba(70,80,70,.12)}.theme-choice small{display:block;font-size:11px}.api-note{margin-top:12px;padding:12px 13px;border-radius:15px;background:var(--accent-soft);color:var(--text);font-size:12px;line-height:1.65}.field input[type=password],.field select{width:100%;border:1px solid #d7e1d2;background:#fbfcf8;border-radius:14px;padding:12px 13px;color:#34483a;outline:none}.inline-actions{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:14px}.connection-row{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-top:16px;padding:13px;border:1px solid var(--line);border-radius:16px;background:color-mix(in srgb,var(--accent-soft) 35%,#fff)}
@media(max-width:560px){.hero{grid-template-columns:82px minmax(0,1fr);gap:15px}.logo{width:80px;height:80px;border-radius:23px}.hero h1{font-size:46px}.hero p{font-size:15px;padding-right:18px}.status-top{grid-template-columns:1fr 1fr}.status-check{grid-column:1/3;width:100%}.status-check .mini-btn{width:100%}.tool-row{grid-template-columns:1fr 1fr}.tool-row .tool-btn:first-child{grid-column:1/3}.api-source{width:100%;margin-left:0}.upload{padding:20px 17px}.file-label{min-height:118px}.theme-grid{grid-template-columns:repeat(3,1fr)}.sheet{padding-bottom:calc(22px + env(safe-area-inset-bottom))}}
@media(max-width:360px){.tool-row{grid-template-columns:1fr}.tool-row .tool-btn:first-child{grid-column:auto}.status-top{grid-template-columns:1fr}.status-check{grid-column:auto}.theme-grid{grid-template-columns:repeat(2,1fr)}}
"""
...
<svg class="decor" viewBox="0 0 150 160" aria-hidden="true"><path d="M83 150c11-38 23-69 52-102-4 40-18 73-52 102Z" fill="currentColor" opacity=".34"/><path d="M72 128c-18-26-37-38-58-42 10 25 28 40 58 42Z" fill="currentColor" opacity=".21"/><path d="M92 99c-8-28-4-52 8-75 9 30 6 55-8 75Z" fill="currentColor" opacity=".27"/><path d="M46 48c-5-15 10-22 17-10 7-12 22-5 17 10-5 12-17 19-17 19S51 60 46 48Z" fill="currentColor" opacity=".25"/></svg>
<section class="hero">__ICON__<div><h1>共看</h1><p>上传视频，让 AI 帮你看画面、听声音，生成清晰总结。</p></div></section>
...
<section class="card status"><div class="status-top">
  ...
  <div class="status-check"><button class="mini-btn" type="button" id="checkBtnTop">检查连接</button></div>
</div>
<div class="model-row"><span>当前模型：</span><span class="model-name" id="modelName">__PRETTY_MODEL__</span><span class="pill">按次计费</span><span class="api-source" id="apiSource">__API_SOURCE__</span></div>
<div class="tool-row"><button class="tool-btn" type="button" id="apiBtn">连接 API<span>自己的 Key / 模型</span></button><button class="tool-btn" type="button" id="themeBtn">换颜色<span>5 套界面主题</span></button><button class="tool-btn" type="button" id="settingsBtn">个性设置<span>称呼 / 句子 / 通知</span></button></div>
</section>__MSG__

<section class="card upload"><form id="uploadForm" enctype="multipart/form-data">
  <div class="file-row"><label class="file-label"><span class="upload-icon">☁</span><span>选择视频文件</span><small>支持 MP4 / MOV / MKV 等常见格式</small><input id="videoInput" type="file" name="video" accept="video/*" required></label><span id="fileName" class="filename">未选择任何文件</span></div>
...
<section class="card"><div class="section-title"><div class="title-left"><span class="badge-icon">◷</span><h2>最近的共看</h2></div><button class="mini-btn danger" type="button" id="clearHistoryBtn">清空记录</button></div><div id="recentArea">__RECENT__</div></section>
<div class="footnote" style="position:relative;overflow:hidden"><span class="info">i</span><div style="position:relative;z-index:1;padding-right:72px"><div>✓ 建议 __MAX_SECONDS__ 秒以内，单个视频不超过 __MAX_MB__MB</div><div>✓ 支持从相册选择；Android 公共版可直接从其他 App 的“分享”菜单交给共看</div><div>✓ 每个人建议使用自己的后端和 API，视频记录彼此隔离</div></div><svg viewBox="0 0 110 90" aria-hidden="true" style="position:absolute;right:-4px;bottom:-10px;width:105px;opacity:.34;color:var(--accent)"><path d="M58 84c8-28 18-51 40-73-3 29-13 54-40 73Z" fill="currentColor"/><path d="M47 72c-16-20-29-28-44-29 9 19 22 28 44 29Z" fill="currentColor" opacity=".62"/><path d="M66 49c-3-18 1-32 10-44 5 19 2 34-10 44Z" fill="currentColor" opacity=".78"/></svg></div>
</main>

<div class="modal" id="themeModal"><section class="sheet" role="dialog" aria-modal="true" aria-label="界面换色"><div class="sheet-head"><h2>换一个共看的颜色</h2><button class="close" id="closeTheme" type="button">×</button></div><div class="api-note">只改变你这台设备上的界面配色，不影响视频、报告和 API。</div><div class="theme-grid" id="themeGrid">
<button class="theme-choice" data-theme="matcha"><span class="swatch" style="background:#78996f"></span><small>抹茶绿</small></button>
<button class="theme-choice" data-theme="cream"><span class="swatch" style="background:#c58f70"></span><small>奶油杏</small></button>
<button class="theme-choice" data-theme="mist"><span class="swatch" style="background:#7397a4"></span><small>雾霾蓝</small></button>
<button class="theme-choice" data-theme="rose"><span class="swatch" style="background:#b98691"></span><small>柔雾粉</small></button>
<button class="theme-choice" data-theme="lilac"><span class="swatch" style="background:#8e84aa"></span><small>浅雾紫</small></button>
</div></section></div>
...
<div class="api-note"><strong>推荐方式：</strong>每个人部署自己的共看后端，然后在这里填自己的 API。Key 只保存在当前设备，本次分析时通过 HTTPS 发给你自己的后端，不写进 GitHub，也不会保存进视频报告。</div>
...
<div class="connection-row"><div><strong>共看服务地址</strong><div style="font-size:12px;color:var(--muted);margin-top:4px">Android 版可在这里更换自己的后端</div></div><button class="mini-btn" type="button" id="serviceSettingsBtn">更换地址</button></div>
...
<div class="diag"><strong>连接检查</strong><div style="font-size:12px;color:#879088;margin-top:4px">检查服务器、当前 API 配置和 MCP 通道。</div><button class="mini-btn" style="margin-top:10px" id="diagBtnApi" type="button">开始检查</button><div class="diag-result" id="diagResultApi">还没有检查</div></div>
</section></div>
...
const STORE='gongkan_persona_v19', THEME_STORE='gongkan_theme_v19', API_STORE='gongkan_api_v19';
const THEME_META={matcha:'#f8f4e9',cream:'#fbf1e6',mist:'#edf4f6',rose:'#faf0f1',lilac:'#f3f0f8'};
let cfg=loadCfg(), apiCfg=loadApiCfg(), analysisTimer=null, lastError='';
...
$('themeBtn').onclick=()=>{$('themeModal').classList.add('open');};$('closeTheme').onclick=()=>$('themeModal').classList.remove('open');$('themeModal').addEventListener('click',e=>{if(e.target===$('themeModal'))$('themeModal').classList.remove('open');});document.querySelectorAll('.theme-choice').forEach(b=>b.onclick=()=>{applyTheme(b.dataset.theme);toast('界面颜色已经换好');});
...
function openSettings(){applyPersona();$('settingsModal').classList.add('open');} function closeSettings(){$('settingsModal').classList.remove('open');}
...
function fillApi(){apiCfg=loadApiCfg();$('apiMode').value=apiCfg.mode||'gemini';$('apiBase').value=apiCfg.base_url||'';$('apiKey').value=apiCfg.api_key||'';$('apiModel').value=apiCfg.model||'';$('apiFallback').value=apiCfg.fallback||'';$('apiAuth').value=apiCfg.auth_style||'query_key';$('apiAudio').value=apiCfg.audio_model||'whisper-1';}
function openApi(){fillApi();$('apiModal').classList.add('open');} function closeApi(){$('apiModal').classList.remove('open');}
...
function clearFailure(){$('retryRow').style.display='none';$('techDetail').style.display='none';lastError='';} function showFailure(detail){lastError=detail||'没有更多技术信息';$('progressWrap').style.display='block';setProgress(0,'没有看成功',t('error'));$('retryRow').style.display='flex';$('techDetail').textContent=lastError;btn.disabled=false;btn.textContent='✦ 开始共看';}
...
function bindRecent(){document.querySelectorAll('[data-delete]').forEach(b=>b.onclick=async e=>{e.preventDefault();e.stopPropagation();if(!confirm('删除这条共看记录吗？'))return;const id=b.dataset.delete;const r=await fetch('/api/report/'+encodeURIComponent(id),{method:'DELETE'});if(r.ok){toast('已经删除');refreshRecent();}});} bindRecent();
...
@app.get("/health")
def health():
    return {"ok": True, "name": "共看", "ui": "v1.9-theme-personal-api"}
